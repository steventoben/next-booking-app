...
export function PropertyListingsGrid(props: ProductGridProps) {
    const {} = props;
    return(
        <Box flex={'1 1 auto'} maxWidth={'60em'} marginX={{base: '1rem', md: '1rem', lg: 'auto'}} margin={'0 auto'} bg={useColorModeValue('gray.100', 'gray.900')} data-auto-id={PropertyListingsGrid.name}>
